package com.github.bjlhx15.chainmaker.demo.common.response;


import com.github.bjlhx15.chainmaker.demo.common.constant.GlobalConstants;
...
/*    public static boolean isNotSuccess(@Nullable com.fish1208.common.response.Result<?> result) {
    ...
    public static <T> Result<T> data(int code, T data, String msg) {
        return new Result<>(code, data, data == null ? GlobalConstants.DEFAULT_NULL_MESSAGE : msg);
    }
