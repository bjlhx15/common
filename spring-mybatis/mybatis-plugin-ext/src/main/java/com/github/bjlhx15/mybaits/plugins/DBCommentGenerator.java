package com.github.bjlhx15.mybaits.plugins;
...
//        suppressAllComments = false;
    ...
    public void addEnumComment(InnerEnum innerEnum, IntrospectedTable introspectedTable) {
        addFieldAndEnumCommon(innerEnum, introspectedTable);
    }

    private void addFieldAndEnumCommon(JavaElement javaElement, IntrospectedTable introspectedTable) {
        if (suppressAllComments) {
            return;
        }
        StringBuilder sb = new StringBuilder();
    ...
    public void addFieldComment(Field field, IntrospectedTable introspectedTable) {
        addFieldAndEnumCommon(field, introspectedTable);
    }
