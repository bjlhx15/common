...
public class GoogleBarCodeUtils {
    ...
    public static BufferedImage insertWords(BufferedImage image, String words) {
        return insertWords(image,words,WIDTH,HEIGHT,WORDHEIGHT);
    }


    public static BufferedImage insertWords(BufferedImage image, String words,int width, int height,int wordHeight) {
